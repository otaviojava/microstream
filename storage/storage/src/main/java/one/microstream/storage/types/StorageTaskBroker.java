...
public interface StorageTaskBroker
{
	...
	public StorageRequestTask enqueueImportFromBinaryTask(Binary data)
		throws InterruptedException;
...
//			return currentHead;
		...
		@Override
		public StorageRequestTask enqueueImportFromBinaryTask(final Binary data) throws InterruptedException
		{
			// always use the internal evaluator to match live operation
			final StorageRequestTaskImportDataBinary task = this.taskCreator.createImportFromBinaryTask(
				this.channelCount          ,
				this.fileEvaluator         ,
				this.objectIdRangeEvaluator,
				data,
